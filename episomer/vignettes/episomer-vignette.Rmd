...
The general principle behind `episomer` is that it collects posts and related metadata from the Twitter Standard API versions 1.1 (https://developer.twitter.com/en/docs/twitter-api/v1/posts/search/overview) and 2 (https://developer.twitter.com/en/docs/twitter-api/posts/search/api-reference/get-posts-search-recent) according to specified topics and stores these posts on your computer on a database that can operate to calculate statistics or as a search engine. `episomer` geolocalises the posts and collects information on key words, URLs, hashtags within a post but also entities and context detected by the Twitter API 2. Posts are aggregated according to topic and geographical location. Next, a signal detection algorithm identifies the number of posts (by topic and geographical location) that exceeds what is expected for a given day. If a number of posts exceeds what is expected, `episomer` sends out email alerts to notify those who need to further investigate these signals following the epidemic intelligence processes (filtering, validation, analysis and preliminary assessment).
...
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/dashboard.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '100%'}
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/alerts.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '100%'}
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/geotag_evaluation.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '100%'}
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/data_protection.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '100%'}
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/config.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '100%'}
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/troubleshoot.png")
```
...
In 2019, ECDC developed a prototype of a manual R-based tool for the early detection of public health threats from Twitter data. The `episomer` package is an extension of this prototype, to allow a wider geolocation of posts and greater automatisation, which first version was published in October 2020.

### Objectives of episomer

The primary objective of `episomer` is to use the Twitter Standard Search API version 1.1 and Twitter Recent Search API version 2 in order to detect early signals of potential threats by topic and by geographical unit.
...
If the command returns null or empty, then you will need to set the Java Home environment variable, for your operating system (OS). Please see your specific OS instructions. In some cases, `episomer` can work without setting the Java Home environment variable.
...
You can launch the `episomer` Shiny app from the R session by typing in the R console. Replace “data\_dir” with the designated data directory (full path) which is a local folder you choose to store posts, time series and configuration files in:
...
### Adding a new new social media
EpiSoMeR is designed to support multiple social media data collection.

#### Common post format
In order to support multiple social media, epiSoMeR transforms each response containing posts into a standardised common format. This format simplifies the handling of distinc types of social media.

The common post format is defined as follow
...
### Setting up post collection and the alert detection loop

In order to use `episomer`, you will need to collect and process posts, run the 'episomer database' and 'Requirements & alerts' pipelines. Further details are also available in subsequent sections of this user documentation. A summary of the steps needed is as follows:
...
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/run_tasks.png")
```

-   Set up the Twitter authentication using a Twitter account or a Twitter developer app, see section *Collection of posts>Twitter authentication* for more details
...
-   Activate the episomer database
...
```
   ...
   -   You can confirm that the episomer database is active if the 'episomer database' status is "Running" in the Shiny app configuration page (green text in screenshot above) and "true" in the Shiny app troubleshoot page.
...
`episomer` uses the Twitter Standard Search API version 1.1 and/or Twitter Recent Search API version 2. The advantage of these APIs is that these are a free service provided by Twitter enabling users of `episomer` to access posts free of charge. The search API is not meant to be an exhaustive source of posts. It searches against a sample of recent posts published in the past 7 days and it focuses on relevance and not completeness. This means that some posts and users may be missing from search results.
...
```{r echo=FALSE, fig.cap="", out.width = '50%'}
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/twitter_authentication.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '100%'}
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/topics.png")
```
...
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/Example_topics_list.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '80%'}
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/Schedule_plan_image.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '80%'}
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/Search_plan_queues.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '80%'}
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/config_languages.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '100%'}
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/subscribers.png")
```
...
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/topics_countries.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '40%'}
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/period.png")
```
...
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/time_unit.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '30%'}
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/include_reposts.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '30%'}
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/location_type.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '30%'}
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/signal_detection_fpr.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '40%'}
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/outlier_dashboard.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '30%'}
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/Bonferroni_correction.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '30%'}
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/days_in_baseline.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '30%'}
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/same_weekday_baseline.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '30%'}
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/hover_trendline.png")
```
...
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/hover_map.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '50%'}
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/top_words.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '50%'}
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/status.png")
```
...
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/detection_pipeline.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '50%'}
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/signal_detection_config.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '40%'}
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/general.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '100%'}
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/languages.png")
```
...
```{r echo=FALSE, fig.cap="", out.width = '100%'}
knitr::include_graphics("https://github.com/EU-ECDC/episomer/raw/master/img/ebola.png")
```
