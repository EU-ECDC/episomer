...
**Social Medias**
This section list the supported social media and allows the user to set credentials and use for each social media provider. Actually only Bluesky is supported.
