...
```{r}
df <- tibble::tibble(episomer::search_tweets(topic = "covid-19"))
...
"PT", "RO", "SK", "SI", "ES", "SE")
 topch4 <- create_topchart(topic = topic, serie = "topwords", country_codes=countries_top_chart,date_min=date_min,date_max=date_max, with_retweets = FALSE, top = 25)
```
...
# test "detailed"
countries <- 276 #USA
m3 <- create_map(topic = topic, countries = countries, date_min = date_min, date_max = date_max, with_retweets = TRUE)
