...
trait GeoTrainingTest extends UnitTest {
  ...
  lazy val trainingSet = {
    ...
    Seq(
      ...
      GeoTraining(category = "Location", text = "Perro", locationInText = None, isLocation = Some(false), forcedLocationCode = None, forcedLocationName = None, source = GeoTrainingSource.episomerModel, tweetId = None, lang = Some("es"), tweetPart = None, foundLocation = None, foundLocationCode = None, foundCountryCode = None),
      GeoTraining(category = "Location", text = "Amigo", locationInText = None, isLocation = Some(false), forcedLocationCode = None, forcedLocationName = None, source = GeoTrainingSource.episomerModel, tweetId = None, lang = Some("es"), tweetPart = None, foundLocation = None, foundLocationCode = None, foundCountryCode = None),
      GeoTraining(category = "Location", text = "Juan", locationInText = None, isLocation = Some(false), forcedLocationCode = None, forcedLocationName = None, source = GeoTrainingSource.episomerModel, tweetId = None, lang = Some("es"), tweetPart = None, foundLocation = None, foundLocationCode = None, foundCountryCode = None),
      GeoTraining(category = "Location", text = "Voy", locationInText = None, isLocation = Some(false), forcedLocationCode = None, forcedLocationName = None, source = GeoTrainingSource.episomerModel, tweetId = None, lang = Some("es"), tweetPart = None, foundLocation = None, foundLocationCode = None, foundCountryCode = None),
      GeoTraining(category = "Location", text = "Siempre", locationInText = None, isLocation = Some(false), forcedLocationCode = None, forcedLocationName = None, source = GeoTrainingSource.episomerModel, tweetId = None, lang = Some("es"), tweetPart = None, foundLocation = None, foundLocationCode = None, foundCountryCode = None),
      GeoTraining(category = "Location", text = "y", locationInText = None, isLocation = Some(false), forcedLocationCode = None, forcedLocationName = None, source = GeoTrainingSource.episomerModel, tweetId = None, lang = Some("es"), tweetPart = None, foundLocation = None, foundLocationCode = None, foundCountryCode = None),
      GeoTraining(category = "Location", text = "a", locationInText = None, isLocation = Some(false), forcedLocationCode = None, forcedLocationName = None, source = GeoTrainingSource.episomerModel, tweetId = None, lang = Some("es"), tweetPart = None, foundLocation = None, foundLocationCode = None, foundCountryCode = None),
      GeoTraining(category = "Location", text = "jugar", locationInText = None, isLocation = Some(false), forcedLocationCode = None, forcedLocationName = None, source = GeoTrainingSource.episomerModel, tweetId = None, lang = Some("es"), tweetPart = None, foundLocation = None, foundLocationCode = None, foundCountryCode = None),
      GeoTraining(category = "Location", text = "Yo", locationInText = None, isLocation = Some(false), forcedLocationCode = None, forcedLocationName = None, source = GeoTrainingSource.episomerModel, tweetId = None, lang = Some("es"), tweetPart = None, foundLocation = None, foundLocationCode = None, foundCountryCode = None),
      GeoTraining(category = "Location", text = "Mendoza", locationInText = None, isLocation = Some(true), forcedLocationCode = None, forcedLocationName = None, source = GeoTrainingSource.episomerModel, tweetId = None, lang = Some("es"), tweetPart = None, foundLocation = None, foundLocationCode = None, foundCountryCode = None),
      GeoTraining(category = "Location", text = "Mozambique", locationInText = None, isLocation = Some(true), forcedLocationCode = None, forcedLocationName = None, source = GeoTrainingSource.episomerModel, tweetId = None, lang = Some("es"), tweetPart = None, foundLocation = None, foundLocationCode = None, foundCountryCode = None),
      GeoTraining(category = "Location", text = "China", locationInText = None, isLocation = Some(true), forcedLocationCode = None, forcedLocationName = None, source = GeoTrainingSource.episomerModel, tweetId = None, lang = Some("es"), tweetPart = None, foundLocation = None, foundLocationCode = None, foundCountryCode = None),
      GeoTraining(category = "Location", text = "Estados unidos de América", locationInText = None, isLocation = Some(true), forcedLocationCode = None, forcedLocationName = None, source = GeoTrainingSource.episomerModel, tweetId = None, lang = Some("es"), tweetPart = None, foundLocation = None, foundLocationCode = None, foundCountryCode = None),
      GeoTraining(category = "Location", text = "USA", locationInText = None, isLocation = Some(true), forcedLocationCode = None, forcedLocationName = None, source = GeoTrainingSource.episomerModel, tweetId = None, lang = Some("es"), tweetPart = None, foundLocation = None, foundLocationCode = None, foundCountryCode = None),
      GeoTraining(category = "Location", text = "Ciudad de México", locationInText = None, isLocation = Some(true), forcedLocationCode = None, forcedLocationName = None, source = GeoTrainingSource.episomerModel, tweetId = None, lang = Some("es"), tweetPart = None, foundLocation = None, foundLocationCode = None, foundCountryCode = None),
