  ...
  line_chart_from_filters <- function(topics, countries, period_type, period, with_retweets, alpha, alpha_outlier, k_decay, no_history, bonferroni_correction, same_weekday_baseline) {
    trend_line(
      topic = topics
  ...
  top_chart_from_filters <- function(topics, serie, fcountries, period, with_retweets, top) {
